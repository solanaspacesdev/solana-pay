...
function validateTransfer(connection_1, signature_1, _a, options_1) {
    return __awaiter(this, arguments, void 0, function* (connection, signature, { recipient, amount, splToken, reference, memo, allowRecipientOffCurve = false }, options) {
        ...
        const [preAmount, postAmount] = splToken
            ? yield validateSPLTokenTransfer(instruction, message, meta, recipient, splToken, reference, allowRecipientOffCurve)
...
function validateSPLTokenTransfer(instruction_1, message_1, meta_1, recipient_1, splToken_1, references_1) {
    return __awaiter(this, arguments, void 0, function* (instruction, message, meta, recipient, splToken, references, allowRecipientOffCurve = false) {
        var _a, _b;
        const recipientATA = yield (0, spl_token_1.getAssociatedTokenAddress)(splToken, recipient, allowRecipientOffCurve);
