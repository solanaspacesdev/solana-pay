 ...
 */
export declare function validateTransfer(connection: Connection, signature: TransactionSignature, { recipient, amount, splToken, reference, memo, allowRecipientOffCurve }: ValidateTransferFields, options?: {
    commitment?: Finality;
