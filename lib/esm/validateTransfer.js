 ...
 */
export async function validateTransfer(connection, signature, { recipient, amount, splToken, reference, memo, allowRecipientOffCurve = false }, options) {
...
async function validateSPLTokenTransfer(instruction, message, meta, recipient, splToken, references, allowRecipientOffCurve = false) {
